...
Profile PEDEV : Name of the search filter to be saved</p>
    ...
    static {
        ...
        allVariables.put('19.1-AWS-MYSQL', allVariables['default'] + ['G_LongTimeout' : 120, 'G_SmallTimeout' : 30, 'BaseURL' : 'http://savphlpedev64/Sav.191Features.Runtime', 'Username' : 'cshah_admin', 'Password' : 'Password1234!', 'Database' : 'AWS_MYSQL_QA', 'DocumentID' : '', 'FilterName' : '', 'MW018_DocID' : '', 'ChartType' : [('PIE') : '//*[name() = \'g\' and contains(@class,\'nv-slice\')]', ('V_BAR') : '//*[name()=\'rect\' and not(@height = \'0\') and contains(@class, \'nv-bar\')]', ('H_BAR') : '//*[name()=\'rect\' and not(@width = \'0\')]'], 'Standard_Timeout' : 60, 'Copy_Report_Name' : '', 'BaseAdminApiURL' : 'http://savphlpedev64/Sav.Maint.AdminApi', 'Users' : [('MW067_UN') : 'Auto_BO_uncheck', ('MW066_UN') : 'Auto_BO_Check', ('MW065_UN') : 'Auto_AI_uncheck', ('MW064_UN') : 'Auto_AI_check', ('MW063_UN') : 'Auto_WI_uncheck', ('MW062_UN') : 'Auto_WI_Check'], 'G_ReportTimeout' : 180])
