...
GlobalVariable.WMI007['Field9'] = DateUtil.getCurrentDateTime(_format)
...
WebUI.setText(findTestObject('Page_WMI_NEW/Reference_Object_Import/NewLinkModalDialog/input_Integer field'), GlobalVariable.WMI007['Field1']) //Integer Field
WebUI.setText(findTestObject('Page_WMI_NEW/Reference_Object_Import/NewLinkModalDialog/input_String Field (with onfocussetcursorattheend attribute)'), GlobalVariable.WMI007['Field2']) //String Field (with onfocussetcursorattheend attribute)
WebUI.selectOptionByLabel(findTestObject('Page_WMI_NEW/Reference_Object_Import/NewLinkModalDialog/input_String Field With Lookup'), GlobalVariable.WMI007['Field3'], false) //String Field With Lookup
WebUI.setText(findTestObject('Page_WMI_NEW/Reference_Object_Import/NewLinkModalDialog/input_Currency Field'), GlobalVariable.WMI007['Field4']) //Currency Field
WebUI.setText(findTestObject('Page_WMI_NEW/Reference_Object_Import/NewLinkModalDialog/input_Date Field'), GlobalVariable.WMI007['Field5']) //Date Field
WebUI.setText(findTestObject('Page_WMI_NEW/Reference_Object_Import/NewLinkModalDialog/input_Float Field (Precision3minval-10maxval-100)'), GlobalVariable.WMI007['Field6']) //Float Field (Precision:3,minval-10,maxval-100)
WebUI.setText(findTestObject('Page_WMI_NEW/Reference_Object_Import/NewLinkModalDialog/input_Small Integer Field(minval-10maxval-100)'), GlobalVariable.WMI007['Field7']) //Small Integer Field(minval-10,maxval-100)
WebUI.setText(findTestObject('Page_WMI_NEW/Reference_Object_Import/NewLinkModalDialog/input_Text Field(with onfocusselectall attribute)'), GlobalVariable.WMI007['Field8']) //Text Field(with onfocusselectall attribute)
WebUI.setText(findTestObject('Page_WMI_NEW/Reference_Object_Import/NewLinkModalDialog/input_DateTime Field'),GlobalVariable.WMI007['Field9']) //DateTime Field
WebUI.setText(findTestObject('Page_WMI_NEW/Reference_Object_Import/NewLinkModalDialog/input_String Filed'), GlobalVariable.WMI007['Field10']) //String Filed
WebUI.setText(findTestObject('Page_WMI_NEW/Reference_Object_Import/NewLinkModalDialog/input_Ext Name Field'), GlobalVariable.WMI007['Field11']) //Ext Name Field
...
String _expectedDocTitle = 'Master Object Feature  -  '+GlobalVariable.WMI007['Field9'].toString().substring(0, 10).replace('-', '/')
...
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI/Master_Object/input_Integer Field'), 'value', GlobalVariable.WMI007['Field1'], GlobalVariable.G_LongTimeout)
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI/Master_Object/input_String Field (with onfocussetcursorattheend attribute)'), 'value', GlobalVariable.WMI007['Field2'], GlobalVariable.G_LongTimeout)
WebUI.verifyOptionSelectedByLabel(findTestObject('Page_WMI/Master_Object/select_String Field With Lookup'), GlobalVariable.WMI007['Field3'], false, GlobalVariable.G_LongTimeout)
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI/Master_Object/input_Currency Field'), 'value', GlobalVariable.WMI007['Field4_View'], GlobalVariable.G_LongTimeout)
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI/Master_Object/input_Date Field'), 'value', GlobalVariable.WMI007['Field5'], GlobalVariable.G_LongTimeout)
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI/Master_Object/input_Float Field (Precision3minval-10maxval-100)'), 'value', GlobalVariable.WMI007['Field6'], GlobalVariable.G_LongTimeout)
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI/Master_Object/input_Small Integer Field(minval-10maxval-100)'), 'value', GlobalVariable.WMI007['Field7'], GlobalVariable.G_LongTimeout)
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI/Master_Object/input_Text Field(with onfocusselectall attribute)'), 'value', GlobalVariable.WMI007['Field8'], GlobalVariable.G_LongTimeout)
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI/Master_Object/input_DateTime Field'), 'value', GlobalVariable.WMI007['Field9'], GlobalVariable.G_LongTimeout)
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI/Master_Object/input_String Field'), 'value', GlobalVariable.WMI007['Field10'], GlobalVariable.G_LongTimeout)
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI/Master_Object/input_Ext Name Field'), 'value', GlobalVariable.WMI007['Field11'], GlobalVariable.G_LongTimeout)