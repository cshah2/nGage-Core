...
String process_Due_Date_End = '02-28-2018 12:00:00 AM'
...
WebUI.setText(findTestObject('Page_nGage_Dashboard/My_Work_Simplified/input_Search_ProcessDueDate_End'), process_Due_Date_End)
...
CustomKeywords.'actions.Table.verifyRecordsWithinDateRange'(findTestObject('Page_nGage_Dashboard/My_Work_Simplified/table_SearchResult'), 8, process_Due_Date_Start, process_Due_Date_End)
