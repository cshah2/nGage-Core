...
//Enter Only Start Date in search field
...
//Validate Records in grid are more than or equal to from date value
CustomKeywords.'actions.Table.verifyRecordsInTableAreMoreThanStartDate'(findTestObject('Page_nGage_Dashboard/Repository/table_SearchResults'), 18, '12-12-2018')