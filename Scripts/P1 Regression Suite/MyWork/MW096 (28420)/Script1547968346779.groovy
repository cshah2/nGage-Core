...
CustomKeywords.'actions.Common.createDocument_MyWorkDateTime'(DC_DATETIMEREQUIRED, DT_DATETIMEREQUIRED, P1_MW095_STARTDATE, P1_MW095_ENDDATE, P1_MW095_STARTDATETIME, P1_MW095_ENDDATETIME, 'Test')
...
CustomKeywords.'actions.Table.verifyDateFilter'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_StartTestDateTime, filterDate1, '', 'Not Null')