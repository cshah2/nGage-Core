...
CustomKeywords.'actions.Common.createDocument_MyWorkDateTime'(Consts.DC_DATETIMEREQUIRED, Consts.DT_DATETIMEREQUIRED, Consts.P1_MW095_STARTDATE, Consts.P1_MW095_ENDDATE, Consts.P1_MW095_STARTDATETIME, Consts.P1_MW095_ENDDATETIME, Consts.P1_MW095_BMTEXT)
...
CustomKeywords.'actions.Table.verifyDateFilter'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_StartTestDateTime, DateUtil.formatDate_Hyphen(Consts.P1_MW084_STARTDATETIME), 'Not Null')