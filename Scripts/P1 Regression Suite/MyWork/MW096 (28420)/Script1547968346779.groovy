...
String treeDate = convert(P1_MW_DOC302.get(Fields.START_DATE_TIME), FORMAT_DATETIME, FORMAT_DATE_TREE)
String filterDate = convert(P1_MW_DOC302.get(Fields.START_DATE_TIME), FORMAT_DATETIME, FORMAT_DATE)
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/process_DateTimeRequired/select_StartDateTime_operater'), 'Not Null', false)
...
CustomKeywords.'actions.Table.verifyDateFilter'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_StartTestDateTime, filterDate, '', 'Not Null')

CustomKeywords.'actions.Table.verifyRecordPresentInColumn'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_StartTestDateTime, P1_MW_DOC301.get(Fields.START_DATE_TIME))
CustomKeywords.'actions.Table.verifyRecordPresentInColumn'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_StartTestDateTime, P1_MW_DOC302.get(Fields.START_DATE_TIME))
CustomKeywords.'actions.Table.verifyRecordPresentInColumn'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_StartTestDateTime, P1_MW_DOC303.get(Fields.START_DATE_TIME))