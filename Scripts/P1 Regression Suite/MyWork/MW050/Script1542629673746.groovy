...
CustomKeywords.'actions.MenuBar.verifyAllSubmenuAreSortedByActivityName'(CustomKeywords.'actions.MenuBar.getAllSubMenu'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/a_NewProcessHoldActivity')),'desc')