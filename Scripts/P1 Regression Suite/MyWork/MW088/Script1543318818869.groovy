...
'Verify searched data should be displayed in the search results'
...
println 'StartTestDate Column Position is - '+ColumnPosition_StartTestDate
...
CustomKeywords.'actions.Table.verifyDateFilter'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'),StartTestDateTime_ColumnPosition, '01/01/2018','>')