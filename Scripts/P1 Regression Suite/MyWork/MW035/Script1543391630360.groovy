...
'Enter date range'
WebUI.setText(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/Process_DateRangeRequired/input_EndTestDate_from'),'01-01-2019')

//WebUI.rightClick(findTestObject('Page_nGage_Dashboard/My_Work/Process_DateRangeRequired/input__from'),'01-01-2011')
