...
'Expand Date folder'
CustomKeywords.'actions.MenuBar.clickTreeMenu'('My_Work','Processes','Date Required','Daterequiredsearch', DateUtil.formatDate_Slash(Consts.P1_MW084_STARTDATE), DateUtil.formatDate_Slash(Consts.P1_MW084_ENDDATE))
CustomKeywords.'actions.Common.waitForFrameToLoad'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/iframe_work_items'))

'Verify the foldered date group should be displayed with only Date (not with time) '
CustomKeywords.'actions.MenuBar.verifyAllActivityNamesAreValidDate'('My_Work','MM/dd/yyyy','Processes','Date Required','Daterequiredsearch', DateUtil.formatDate_Slash(Consts.P1_MW084_STARTDATE))