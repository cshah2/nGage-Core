...
String lastPageNumberText = WebUI.getText(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/span_DisplayedTotalCount'))
int lastPageNumber = 0
if(StringUtils.isNotBlank(lastPageNumberText)) {
	lastPageNumber = Integer.parseInt(lastPageNumberText)
}
...
'Verify current page number is last page'
WebUI.verifyEqual(afterCount, lastPageNumber)
