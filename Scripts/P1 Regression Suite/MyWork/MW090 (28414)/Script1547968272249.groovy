...
CustomKeywords.'actions.Common.createDocument_MyWorkDateTime'(DC_DATETIMEREQUIRED, DT_DATETIMEREQUIRED, P1_MW087_STARTDATE, P1_MW087_ENDDATE, P1_MW087_STARTDATETIME, P1_MW087_ENDDATETIME, 'Test')
...
String treeDate = convert(P1_MW087_STARTDATETIME, FORMAT_DATETIME, FORMAT_DATE_TREE)
String filterDate1 = convert(P1_MW087_STARTDATETIME, FORMAT_DATETIME, FORMAT_DATE)
...
CustomKeywords.'actions.Table.verifyDateTimeFilter'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_StartTestDateTime, filterDate1+' '+P1_TIME_START, filterDate1+' '+P1_TIME_END, 'not between')