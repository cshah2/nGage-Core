...
String treeDate = convert(P1_MW_DOCL_STARTDATETIME, FORMAT_DATETIME, FORMAT_DATE_TREE)
String filterDate = convert(P1_MW_DOCL_STARTDATETIME, FORMAT_DATETIME, FORMAT_DATE)
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), 1, colNo_StartTestDateTime, P1_MW_DOCL_STARTDATETIME)