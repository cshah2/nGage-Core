...
String filterDate1 = convert(P1_MW_DOCL_STARTDATETIME, FORMAT_DATETIME, FORMAT_DATE)
String filterDate2 = convert(P1_MW_DOCM_STARTDATETIME, FORMAT_DATETIME, FORMAT_DATE)
