...
'Create Documents'
CustomKeywords.'actions.Common.createDocument_ProcessForTaskDT'(Consts.P1_MW_PROCESSFORTASK_CUSTOMERNAME_DOC3, Consts.P1_MW_PROCESSFORTASK_CUSTOMERDESC_DOC3)
CustomKeywords.'actions.Common.createDocument_ProcessForTaskDT'(Consts.P1_MW_PROCESSFORTASK_CUSTOMERNAME_DOC4, Consts.P1_MW_PROCESSFORTASK_CUSTOMERDESC_DOC4)
...
Consts.P1_MW_PROCESSFORTASK_DOCID_DOC3 = CustomKeywords.'actions.Table.getCellText'(findTestObject('Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), 2, colNo_DocID) 
Consts.P1_MW_PROCESSFORTASK_DOCID_DOC4 = CustomKeywords.'actions.Table.getCellText'(findTestObject('Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), 1, colNo_DocID)
...
CustomKeywords.'actions.Table.verifyRecordPresentInColumn'(findTestObject('Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_DocID, Consts.P1_MW_PROCESSFORTASK_DOCID_DOC3)
CustomKeywords.'actions.Table.verifyRecordNotPresentInColumn'(findTestObject('Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_DocID, Consts.P1_MW_PROCESSFORTASK_DOCID_DOC4)
...
'Verify Correct Document ID is present in grid'
CustomKeywords.'actions.Table.verifyRecordPresentInColumn'(findTestObject('Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_DocID, Consts.P1_MW_PROCESSFORTASK_DOCID_DOC4)
CustomKeywords.'actions.Table.verifyRecordNotPresentInColumn'(findTestObject('Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_DocID, Consts.P1_MW_PROCESSFORTASK_DOCID_DOC3)
