...
String treeDate = convert(P1_MW_DOC322.get(Fields.START_DATE_TIME), FORMAT_DATETIME, FORMAT_DATE_TREE)
String filterDate = convert(P1_MW_DOC322.get(Fields.START_DATE_TIME), FORMAT_DATETIME, FORMAT_DATE)
