...
String startDateTime = P1_MW_DOC322.get(Fields.START_DATE_TIME)
String endDateTime = P1_MW_DOC324.get(Fields.START_DATE_TIME)
...
CustomKeywords.'actions.Table.verifyRecordPresentInColumn'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_StartTestDatetime, P1_MW_DOC322.get(Fields.START_DATE_TIME))
CustomKeywords.'actions.Table.verifyRecordPresentInColumn'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_StartTestDatetime, P1_MW_DOC323.get(Fields.START_DATE_TIME))
CustomKeywords.'actions.Table.verifyRecordPresentInColumn'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/table_MyWorkSearchResults'), colNo_StartTestDatetime, P1_MW_DOC324.get(Fields.START_DATE_TIME))
