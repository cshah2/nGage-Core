...
'verify sorted order of sub menus (DEsc by activity counts)'
CustomKeywords.'actions.MenuBar.verifyAllSubmenuAreSortedByActivityCount'(CustomKeywords.'actions.MenuBar.getAllSubMenu'(findTestObject('Object Repository/Page_nGage_Dashboard/My_Work/a_NewProcessHoldActivity')),'desc')