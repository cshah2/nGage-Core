...
String treeDate = convert(P1_MW_DOC261.get(Fields.START_DATE), FORMAT_DATE, FORMAT_DATE_TREE)
...
CustomKeywords.'actions.Common.setText_Date'(findTestObject('Page_nGage_Dashboard/My_Work/Process_Date Required/input_StartDate'), filterDate1)
