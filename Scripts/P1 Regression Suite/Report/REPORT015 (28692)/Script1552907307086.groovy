...
'Click on close all oprtion'
CustomKeywords.'actions.ContextMenu.clickOption'(findTestObject('Page_nGage_Dashboard/Report/contextMenu_Tabs'), 'Close all')

'Verify all the tabs are closed'
WebUI.verifyElementNotPresent(findTestObject('Page_nGage_Dashboard/Report/tab_User Listing'), GlobalVariable.G_LongTimeout)
WebUI.verifyElementNotPresent(findTestObject('Page_nGage_Dashboard/Report/tab_User Group Membership'), GlobalVariable.G_LongTimeout)
WebUI.verifyElementNotPresent(findTestObject('Page_nGage_Dashboard/Report/tab_User Group Listing'), GlobalVariable.G_LongTimeout)
WebUI.verifyElementNotPresent(findTestObject('Page_nGage_Dashboard/Report/tab_User Access to Document Classes'), GlobalVariable.G_LongTimeout)
