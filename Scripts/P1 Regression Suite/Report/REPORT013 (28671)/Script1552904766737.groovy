...
WebUI.setText(findTestObject('Page_nGage_Dashboard/Report/CopyReport/input_NewReportName'), 'BASE REPORT')
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Page_nGage_Dashboard/Report/CopyReport/label_SuccessMessage')).trim(), 'Report Name already exists in system.', false)