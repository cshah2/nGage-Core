...
WebUI.verifyMatch(WebUI.getText(findTestObject('Page_nGage_Dashboard/Report/RenameReport/label_CurrentReportName')).trim(), GlobalVariable.Copy_Report_Name, false)
...
String oldName = GlobalVariable.Copy_Report_Name
GlobalVariable.Copy_Report_Name = 'RENAME:'+DateUtil.getCurrentDateTime('yyyyMMdd:HHmmss')

'Enter new Report name'
WebUI.setText(findTestObject('Page_nGage_Dashboard/Report/RenameReport/input_Rename To'), GlobalVariable.Copy_Report_Name)
