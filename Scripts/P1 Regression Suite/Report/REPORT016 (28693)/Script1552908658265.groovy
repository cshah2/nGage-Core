...
'Click on close all except this option'
CustomKeywords.'actions.ContextMenu.clickOption'(findTestObject('Page_nGage_Dashboard/Report/contextMenu_Tabs'), 'Close all except this')

'Verify other the tabs are closed'
...
'Verify selected tab is still present'
WebUI.verifyElementPresent(findTestObject('Page_nGage_Dashboard/Report/tab_User Access to Document Classes'), GlobalVariable.G_LongTimeout)