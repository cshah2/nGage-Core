...
'Selecting Value 4'
WebUI.click(findTestObject('Page_WMI_NEW/Object Tabout Event/CheckboxListEvent/chkbox4_ReferenceObjectSelectOption'))
...
WebUI.verifyElementChecked(findTestObject('Page_WMI_NEW/Object Tabout Event/CheckboxListEvent/chkbox4_ReferenceObjectSelectOption'), GlobalVariable.G_LongTimeout)
WebUI.delay(10)