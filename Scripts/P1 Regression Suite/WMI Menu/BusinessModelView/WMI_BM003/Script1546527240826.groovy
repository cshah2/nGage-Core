...
'Verify rows in the table should 1'
int rowCount = CustomKeywords.'actions.Table.getRowsCount'(findTestObject('Page_WMI_NEW/BusinessModelView/StandardGrid/Notes/table_RowCount'))
WebUI.verifyEqual(rowCount, 1, FailureHandling.STOP_ON_FAILURE)

'Verify the footer "Back to Top" link displayed at the bottom'
WebUI.verifyElementVisible(findTestObject('Page_WMI_NEW/BusinessModelView/StandardGrid/Notes/notes_BackToTop'))
