...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_WMI_NEW/BusinessModelView/StandardGrid/Related_Document(Parent)/a_ Back to Top'), GlobalVariable.G_LongTimeout)