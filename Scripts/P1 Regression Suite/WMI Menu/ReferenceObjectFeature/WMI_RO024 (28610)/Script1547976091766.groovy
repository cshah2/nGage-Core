...
CustomKeywords.'actions.Common.waitForFrameToLoad'(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/CustomButton/tab2_CustomButtons/iframe_Close Window_ContentPla'))
...
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/CustomButton/tab2_CustomButtons/input_SecondCheckBox'))
...
'Get text alert on the alert when it is shown'
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/CustomButton/tab2_CustomButtons/AlertBox/div_Alert_Window'))
CustomKeywords.'actions.Common.waitForFrameToLoad'(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/CustomButton/tab2_CustomButtons/AlertBox/iframe_Close Window_ContentPla'))

'Verify text alert '
String verifyAlertText =  WebUI.getText(findTestObject('Page_WMI_NEW/Reference_Object_Feature/CustomButton/tab2_CustomButtons/AlertBox/Dialog_Alertmsg'))
WebUI.verifyMatch(verifyAlertText, 'Only one item can be selected to perform this action.',false)
