...
'Click on tab - 7) Reference Grid (hideprint-false) '
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/span_7) Reference Grid (hidepr'))
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)

'verify icon having tooltip-Print all or only selected displayed in grid'
CustomKeywords.'actions.Table.verifyButtonPresentInWMITable'(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/tab_7) Reference Grid (hideprint-false)/table_GVGrid'),'Print all or only selected')