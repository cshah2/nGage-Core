...
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/ExtAppURL/tab_2_ExtAppURL/span_2) Extappurl'))
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)

'Verify 2) Extrappurl should be displayed with New dropdown having Two Doc types only.'
WebUI.mouseOver(findTestObject('Page_WMI_NEW/Reference_Object_Feature/ExtAppURL/tab_2_ExtAppURL/div_New'))
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/ExtAppURL/tab_2_ExtAppURL/a_Render As CheckBox'),GlobalVariable.G_LongTimeout)
WebUI.mouseOver(findTestObject('Page_WMI_NEW/Reference_Object_Feature/ExtAppURL/tab_2_ExtAppURL/div_New'))
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/ExtAppURL/tab_2_ExtAppURL/a_Render As Label'),GlobalVariable.G_LongTimeout)
...
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/ExtAppURL/tab_2_ExtAppURL/input_Save'))
WebUI.waitForPageLoad(GlobalVariable.G_LongTimeout)
