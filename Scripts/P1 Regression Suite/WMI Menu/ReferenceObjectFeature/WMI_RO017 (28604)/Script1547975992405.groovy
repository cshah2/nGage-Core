...
'Verify tab 1)ExtAppURL displayes Reference Grid'
...
'click on tab 1) ExtAppURL'
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/ExtAppURL/tab_1_ExtAppURL/span_1) Extappurl'))
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)

'Verify 1) Extrappurl should be displayed with New dropdown having different Doc types'
CustomKeywords.'actions.Common.verifyElementsCount'(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/ExtAppURL/tab_1_ExtAppURL/list_New'), 107)

'Select Doc Type Render as Label'
WebUI.mouseOver(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/ExtAppURL/tab_1_ExtAppURL/span_New'))
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/ExtAppURL/tab_1_ExtAppURL/a_Render As Label'),GlobalVariable.G_LongTimeout)
...
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/ExtAppURL/tab_1_ExtAppURL/input_Save'))
WebUI.waitForPageLoad(GlobalVariable.G_LongTimeout)
