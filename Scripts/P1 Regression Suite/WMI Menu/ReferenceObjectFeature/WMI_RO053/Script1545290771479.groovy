...
'Click on tab - 20) Reference (showcheckboxes-false).'
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/span_20) Reference Grid (showc'))
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)

'verify checkboxes not displayed in the grid'
