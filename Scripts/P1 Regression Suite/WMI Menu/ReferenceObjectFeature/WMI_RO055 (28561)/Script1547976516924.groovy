...
'Click on tab -22 Reference Grid (viewallitems-false)'
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/span_22) Reference Grid (viewa'))
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)

'verify open all selected item icon not present on the grid'
CustomKeywords.'actions.Table.verifyButtonNotPresentInWMITable'(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/tab_22)Reference Grid (viewallitems-false)/table_GVGrid'), 'Open all selected items')
