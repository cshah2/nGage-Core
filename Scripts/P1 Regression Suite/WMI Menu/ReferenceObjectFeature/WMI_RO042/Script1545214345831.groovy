...
'Click on tab - 9) Reference Grid (hidedownload-false)'
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/span_9) Reference Grid (hidedo'))
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)

'verify Download Icon having tool tip "Download all or only selected" displayed on the heading of reference grid.'
CustomKeywords.'actions.Table.verifyButtonPresentInWMITable'(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/tab_9) Reference Grid (hidedownload-false)/table_GVGrid'),'Download all or only selected')