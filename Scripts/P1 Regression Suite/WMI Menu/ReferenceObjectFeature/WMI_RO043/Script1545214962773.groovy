...
'Click on tab -10) Reference Grid (hidedownload-true) '
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/span_10) Reference Grid (hided'))
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)

'verify Download Icon having tool tip "Download all or only selected" not displayed on the heading of reference grid.'
CustomKeywords.'actions.Table.verifyButtonNotPresentInWMITable'(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/tab_10) Reference Grid (hidedownload-true)/table_GVGrid'),'Download all or only selected')