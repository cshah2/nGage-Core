...
//TODO: Script works manually, but there is some issue when using Admin API
'Get User ID for user'
String username = 'Auto_Test8'
...
'Fill change password form'
CustomKeywords.'actions.Common.changePasswordPageFormFill'(username, password3, password2, password2)
...
WebUI.verifyElementText(findTestObject('Page_nGage_Dashboard/Home/ChangePassword/label_ErrorMessage'), 'This password has been used recently. Please enter a new password.')