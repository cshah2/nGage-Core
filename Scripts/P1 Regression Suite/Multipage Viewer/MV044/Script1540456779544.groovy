...
'Click on toggle slider button to close thumbnail section'
WebUI.click(findTestObject('Page_WMI/Clipboard/Slider_toggler'))
WebUI.delay(2)

'Verify Thumbnail section is hidden'
WebUI.verifyElementVisible(findTestObject('Page_WMI/Clipboard/Slider_closed_Thumbnail'))
WebUI.verifyElementNotVisible(findTestObject('Page_WMI/Clipboard/section_Thumbnail'))

'Click on toggle slider button to open thumbnail section'
WebUI.click(findTestObject('Page_WMI/Clipboard/Slider_toggler'))
WebUI.delay(2)
