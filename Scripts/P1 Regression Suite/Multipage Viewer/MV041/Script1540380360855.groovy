...
'Verify Page summary'
WebUI.verifyMatch(WebUI.getText(findTestObject('Page_WMI/Clipboard/pagination_summary')).trim(), '.*Page 2/3.*', true)

'Select Thumbnail 3'
WebUI.click(findTestObject('Page_WMI/Clipboard/Thumbnail 3'))
WebUI.waitForPageLoad(GlobalVariable.G_LongTimeout)
