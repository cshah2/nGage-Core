...
WebUI.setText(findTestObject('Page_WMI/WMI_Menu_BOV_Vertical/ContentFrame/input_PageNumber'), '20')
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Page_WMI/WMI_Menu_BOV_Vertical/ContentFrame/pageCount')).trim(), '.*Page 20/50.*', true)
...
'Verify page count summary'
WebUI.verifyMatch(WebUI.getText(findTestObject('Page_WMI/WMI_Menu_BOV_Vertical/ContentFrame/pageCount')).trim(), '.*Page 19/50.*', true)
