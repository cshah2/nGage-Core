...
'Click on Replace'
WebUI.waitForElementVisible(findTestObject('Page_WMI/WMI_Menu_BOV_Vertical/ContentFrame/subMenu_Page_Replace'), GlobalVariable.G_LongTimeout)
WebUI.click(findTestObject('Page_WMI/WMI_Menu_BOV_Vertical/ContentFrame/subMenu_Page_Replace'))

String filePathUpd = RunConfiguration.getProjectDir().replace('/', '\\')+'\\Data Files\\FileUploads\\ReplaceTextSingle.pdf'
...
WebUI.verifyMatch(actText, '.*REPLACE 1.*', true)