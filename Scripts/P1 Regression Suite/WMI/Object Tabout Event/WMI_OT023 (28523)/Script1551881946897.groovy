...
WebUI.check(findTestObject('Page_WMI_NEW/Object Tabout Event/CheckboxListEvent/tab_SingleResult/chkbox_Value2'))

'Wait for JavaScript event to complete'
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)

'Verify value displayed in String field'
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI_NEW/Object Tabout Event/CheckboxListEvent/tab_SingleResult/input_StringField'), 'value', 'You selected Option 2', GlobalVariable.G_LongTimeout)
