...
WebUI.check(findTestObject('Page_WMI_NEW/Object Tabout Event/CheckboxListEvent/tab_Inline/chkbox_Value3'))

'Wait for JavaScript event to complete'
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)

'Verify value displayed in String field'
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI_NEW/Object Tabout Event/CheckboxListEvent/tab_Inline/input_StringField'), 'value', 'You have selected other option', GlobalVariable.G_LongTimeout)
