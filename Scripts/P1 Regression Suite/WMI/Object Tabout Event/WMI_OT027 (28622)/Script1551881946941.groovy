...
WebUI.verifyOptionPresentByLabel(findTestObject('Page_WMI_NEW/Object Tabout Event/CheckboxListEvent/select_LookupField_InlineTab'), 'Render As Label', false, GlobalVariable.G_LongTimeout)
...
'Verify checkbox 3 is selected'
WebUI.verifyElementChecked(findTestObject('Page_WMI_NEW/Object Tabout Event/CheckboxListEvent/chkbox3_MasterObjectSelectOption'), GlobalVariable.G_LongTimeout)