...
String expText = 'Selected Value (Value 3 or above)'
...
WebUI.verifyElementVisible(findTestObject('Page_WMI_NEW/Object Tabout Event/DropDown Event/tab_InlineView/input_DateField'))
