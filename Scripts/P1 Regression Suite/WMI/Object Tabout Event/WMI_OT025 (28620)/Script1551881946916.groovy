...
WebUI.check(findTestObject('Page_WMI_NEW/Object Tabout Event/CheckboxListEvent/tab_Inline/chkbox_Value1'))

'Wait for JavaScript event to complete'
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)

'Verify value displayed in String field'
WebUI.verifyElementAttributeValue(findTestObject('Page_WMI_NEW/Object Tabout Event/CheckboxListEvent/tab_Inline/input_StringField'), 'value', 'You selected Option 1', GlobalVariable.G_LongTimeout)
