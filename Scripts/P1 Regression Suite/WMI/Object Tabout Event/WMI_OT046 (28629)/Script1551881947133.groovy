...
TestObject refenceSelect1 = findTestObject('Page_WMI_NEW/Object Tabout Event/Nested Lookup Event/tab_Inline View/select_Level1')
TestObject refenceSelect2 = findTestObject('Page_WMI_NEW/Object Tabout Event/Nested Lookup Event/tab_Inline View/select_Level2')
TestObject refenceSelect3 = findTestObject('Page_WMI_NEW/Object Tabout Event/Nested Lookup Event/tab_Inline View/select_Level3')
...
WebUI.click(findTestObject('Page_WMI_NEW/Object Tabout Event/Nested Lookup Event/tab_InlineView'))

'sort grid records in descending accordindg to docID'
WebUI.click(findTestObject('Page_WMI_NEW/Object Tabout Event/Nested Lookup Event/tab_Inline View/tableHeader_DocID'))
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)
WebUI.click(findTestObject('Page_WMI_NEW/Object Tabout Event/Nested Lookup Event/tab_Inline View/tableHeader_DocID'))
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)

'click on first record in the grid'
CustomKeywords.'actions.Table.clickCell'(findTestObject('Page_WMI_NEW/Object Tabout Event/Nested Lookup Event/tab_Inline View/table_InlineResult'), 1, 5)
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)
...
WebUI.click(findTestObject('Page_WMI_NEW/Object Tabout Event/Nested Lookup Event/tab_Inline View/btn_Save'))
