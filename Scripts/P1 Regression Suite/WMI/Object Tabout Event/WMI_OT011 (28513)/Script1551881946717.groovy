...
WebUI.waitForElementVisible(findTestObject('Page_WMI_NEW/Object Tabout Event/Radio List Event/input_Value2_MasterObject'),GlobalVariable.G_LongTimeout)
WebUI.check(findTestObject('Page_WMI_NEW/Object Tabout Event/Radio List Event/input_Value2_MasterObject'))
