...
'check checkbox'
WebUI.check(findTestObject('Page_WMI_NEW/Object Tabout Event/DoNotSetValueOnLoad SetFocus Event/InlineView/chkbox_Control'))
...
CustomKeywords.'actions.Common.verifyElementHasFocus'(findTestObject('Page_WMI_NEW/Object Tabout Event/DoNotSetValueOnLoad SetFocus Event/InlineView/input_CurrencyField'))
