...
//CustomKeywords.'actions.Common.waitForFrameToLoad'(findTestObject('Page_WMI_NEW/iframe_Close Window_ContentPla'))
...
CustomKeywords.'actions.Common.verifyCssValue'(findTestObject('Object Repository/Page_WMI_NEW/Object Tabout Event/Textbox with Section Event/div_Sample Section'), 'background-color', 'rgba(255, 165, 0, 1)')
...
WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Page_WMI_NEW/Object Tabout Event/Textbox with Section Event/input_Master Object Event_efor'), 'value', 'Background', GlobalVariable.G_LongTimeout)
