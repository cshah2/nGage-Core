...
WebUI.waitForPageLoad(GlobalVariable.G_LongTimeout)
CustomKeywords.'actions.Common.verifyMatch'(WebUI.getAttribute(findTestObject('Page_WMI/WMI_Menu_BOV/SendToRecepient/EmailFinder/iframe_Close_iframeDialog'), 'src'), '.*SelectUserEmail.aspx.*', true)
...
WebUI.waitForPageLoad(GlobalVariable.G_LongTimeout)
CustomKeywords.'actions.Common.verifyMatch'(WebUI.getAttribute(findTestObject('Page_WMI/WMI_Menu_BOV_Default/SendToRecepient/EmailFinder/iframe_Close_iframeDialog'), 'src'), '.*SelectUserEmail.aspx.*', true)
...
WebUI.waitForPageLoad(GlobalVariable.G_LongTimeout)
CustomKeywords.'actions.Common.verifyMatch'(WebUI.getAttribute(findTestObject('Page_WMI/WMI_Menu_BOV_DocTwoRow/SendToRecepient/EmailFinder/iframe_Close_iframeDialog'), 'src'), '.*SelectUserEmail.aspx.*', true)
