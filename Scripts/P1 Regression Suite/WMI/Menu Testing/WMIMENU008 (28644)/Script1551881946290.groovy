...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV/span_VerifyHistory')), '.*BPM History.*', true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV_Default/span_VerifyHistory')), '.*BPM History.*', true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV_DocTwoRow/span_VerifyHistory')), '.*BPM History.*', true)
