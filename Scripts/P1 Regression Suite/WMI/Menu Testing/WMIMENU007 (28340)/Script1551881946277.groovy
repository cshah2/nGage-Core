...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV/span_VerifyHistory')), '.*Audit History.*', true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV_Default/span_VerifyHistory')), '.*Audit History.*', true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV_DocTwoRow/span_VerifyHistory')), '.*Audit History.*', true)
