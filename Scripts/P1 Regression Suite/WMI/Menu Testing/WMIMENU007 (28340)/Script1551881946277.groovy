...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV/a_AuditHistory'), GlobalVariable.G_LongTimeout)
WebUI.click(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV/a_AuditHistory'))
WebUI.waitForPageLoad(GlobalVariable.G_LongTimeout)
...
CustomKeywords.'actions.Common.verifyMatch'(WebUI.getText(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV/span_VerifyHistory')), '.*Audit History.*', true)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV_Default/a_AuditHistory'), GlobalVariable.G_LongTimeout)
WebUI.click(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV_Default/a_AuditHistory'))
WebUI.waitForPageLoad(GlobalVariable.G_LongTimeout)
...
CustomKeywords.'actions.Common.verifyMatch'(WebUI.getText(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV_Default/span_VerifyHistory')), '.*Audit History.*', true)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV_DocTwoRow/a_AuditHistory'), GlobalVariable.G_LongTimeout)
WebUI.click(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV_DocTwoRow/a_AuditHistory'))
WebUI.waitForPageLoad(GlobalVariable.G_LongTimeout)
...
CustomKeywords.'actions.Common.verifyMatch'(WebUI.getText(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV_DocTwoRow/span_VerifyHistory')), '.*Audit History.*', true)
