...
CustomKeywords.'actions.Common.verifyMatch'(WebUI.getAttribute(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV/iframe_Close_ContentPlaceHolde'), 'src'), '.*PropertyNoMenujq.*', true)
...
CustomKeywords.'actions.Common.verifyMatch'(WebUI.getAttribute(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV_Default/iframe_Close_ContentPlaceHolde'), 'src'), '.*PropertyNoMenujq.aspx.*', true)
...
CustomKeywords.'actions.Common.verifyMatch'(WebUI.getAttribute(findTestObject('Object Repository/Page_WMI/WMI_Menu_BOV_DocTwoRow/iframe_Close_ContentPlaceHolde'), 'src'), '.*PropertyNoMenujq.aspx.*', true)
