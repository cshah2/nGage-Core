...
CustomKeywords.'actions.Common.verifyMatch'(WebUI.getAttribute(findTestObject('Page_WMI/WMI_Menu_BOV/form_ContentPlaceHolder1'), 'action'), '.*splitpage.aspx.*', true)
...
CustomKeywords.'actions.Common.verifyMatch'(WebUI.getAttribute(findTestObject('Page_WMI/WMI_Menu_BOV_Default/form_ContentPlaceHolder1'), 'action'), '.*splitpage.aspx.*', true)
...
CustomKeywords.'actions.Common.verifyMatch'(WebUI.getAttribute(findTestObject('Page_WMI/WMI_Menu_BOV_DocTwoRow/form_ContentPlaceHolder1'), 'action'), '.*splitpage.aspx.*', true)
