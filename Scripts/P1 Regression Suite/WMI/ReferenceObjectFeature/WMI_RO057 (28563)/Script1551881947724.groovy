...
'Click on tab - 24) Reference Grid (ViewAllContents-true).'
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/span_24) Reference Grid (ViewA'))
...
WebUI.verifyElementChecked(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/tab_24) Reference Grid (ViewAllContents-true)/input_checkFirstRow'), GlobalVariable.G_LongTimeout)

'check all records in grid'
WebUI.check(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/tab_24) Reference Grid (ViewAllContents-true)/input_checkAll'))

'verify all the records in grid are checked'
CustomKeywords.'actions.Table.verifyAllRecordsAreChecked'(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/tab_24) Reference Grid (ViewAllContents-true)/table_GVGrid'))