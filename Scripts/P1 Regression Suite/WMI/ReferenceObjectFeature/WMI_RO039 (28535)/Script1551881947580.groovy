...
'Click on tab - 6) reference Grid (hidegridprint-True)'
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/span_6) Reference Grid (hidegr'))
CustomKeywords.'actions.Common.waitForTabLoading'(null, GlobalVariable.G_LongTimeout)

'verify icon print grid not present'
CustomKeywords.'actions.Table.verifyButtonNotPresentInWMITable'(findTestObject('Object Repository/Page_WMI_NEW/Reference_Object_Feature/Reference_Grid_feature/tab_6) reference Grid (hidegridprint-True)/table_GVGrid'),'Print grid')