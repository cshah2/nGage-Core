...
'Verify fields displayed under Master Object'
WebUI.verifyElementVisible(findTestObject('Page_WMI_NEW/WMISegment/DocType_WMI Segment Master Refere'))
WebUI.verifyElementVisible(findTestObject('Page_WMI_NEW/WMISegment/input_Segment Name'))
WebUI.verifyElementVisible(findTestObject('Page_WMI_NEW/WMISegment/input_Segment Address'))