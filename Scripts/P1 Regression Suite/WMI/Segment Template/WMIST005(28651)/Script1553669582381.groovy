...
'MouseHover on History menu > Click on Audit History menu and verify that Audit History is displayed'
WebUI.mouseOver(findTestObject('Page_WMI_NEW/WMISegment/button_History'))
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_WMI_NEW/WMISegment/submenu_Audit History'))
WebUI.click(findTestObject('Object Repository/Page_WMI_NEW/WMISegment/submenu_Audit History'))
WebUI.verifyElementText(findTestObject('Page_WMI_NEW/WMISegment/title_menu'), 'Audit History')
...
WebUI.verifyMatch(src, '.*nid=AUDITHISTORY.*', true)

'MouseHover on History menu > Click on Revision History menu and verify that Revision History is displayed'
WebUI.mouseOver(findTestObject('Page_WMI_NEW/WMISegment/button_History'))
WebUI.verifyElementVisible(findTestObject('Page_WMI_NEW/WMISegment/subMenu_Revision History'))
WebUI.click(findTestObject('Page_WMI_NEW/WMISegment/subMenu_Revision History'))
...
WebUI.verifyElementText(findTestObject('Page_WMI_NEW/WMISegment/title_menu'), 'Revision History')
String src_RivHistory = WebUI.getAttribute(findTestObject('Object Repository/Page_WMI_NEW/WMISegment/iframe_Close_ContentPlaceHolde'), 'src')
WebUI.verifyMatch(src_RivHistory, '.*nid=REVHISTORY.*', true)
