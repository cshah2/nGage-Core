...
WebUI.setText(findTestObject('Page_Login/input_UserName'), 'apatiln')
...
//Verify and click on Submit button
WebUI.verifyElementVisible(findTestObject("Object Repository/Page_Login/Submit button"))
WebUI.click(findTestObject("Object Repository/Page_Login/Submit button"))
