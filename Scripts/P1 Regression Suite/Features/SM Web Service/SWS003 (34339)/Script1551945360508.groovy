...
'Create document'
CustomKeywords.'actions.Data.create'(DocClass.SM_WEBSERVICE_FILE_1, DocType.SM_WEBSERVICE_FILE_1, P1_WMI_DOC041)
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_nGage_Dashboard/Home/table_MyDocumentResults'), 1, colNo_DocType, DocType.SM_WEBSERVICE_FILE_1.toString())
...
WebUI.waitForElementNotVisible(findTestObject('Page_WMI/SM Web Service/FILE_0001/image_Processing'), GlobalVariable.G_LongTimeout)
CustomKeywords.'actions.Common.waitForImageRender'(findTestObject('Page_WMI/SM Web Service/FILE_0001/image'))

'Verify Intial page count summary'
WebUI.verifyMatch(WebUI.getText(findTestObject('Page_WMI/SM Web Service/FILE_0001/lbl_PageSummary')).trim(), '.*Page 1/8.*', true)
