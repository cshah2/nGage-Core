...
'Create document'
CustomKeywords.'actions.Data.create'(DocClass.SM_WEBSERVICE_FILE_2, DocType.SM_WEBSERVICE_FILE_2, P1_WMI_DOC043)
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_nGage_Dashboard/Home/table_MyDocumentResults'), 1, colNo_DocType, DocType.SM_WEBSERVICE_FILE_2.toString())
