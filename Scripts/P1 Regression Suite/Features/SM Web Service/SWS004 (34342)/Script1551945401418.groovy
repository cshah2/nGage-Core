...
'Create document'
CustomKeywords.'actions.Data.create'(DocClass.SM_WEBSERVICE_DB_1, DocType.SM_WEBSERVICE_DB_1, P1_WMI_DOC042)
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_nGage_Dashboard/Home/table_MyDocumentResults'), 1, colNo_DocType, DocType.SM_WEBSERVICE_DB_1.toString())
...
WebUI.waitForElementNotVisible(findTestObject('Page_WMI/SM Web Service/DB_0001/image_Processing'), GlobalVariable.G_LongTimeout)
CustomKeywords.'actions.Common.waitForImageRender'(findTestObject('Page_WMI/SM Web Service/DB_0001/image'))
