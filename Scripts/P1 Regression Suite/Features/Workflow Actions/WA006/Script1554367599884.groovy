...
CustomKeywords.'actions.Common.selectDocClassAndDocTypeForGlobalNew'(DocClass.INTERFACE_TEST_PR.toString(), DocType.INTERFACE_TEST_PR_ACTIVITY1.toString())
...
'Click on Action'
CustomKeywords.'actions.Window.clickElementAndWaitForWindowClose'(findTestObject('Page_WMI/Interface Test PR/btn_A6_AddRelatedItemZToWOrkinder'), GlobalVariable.G_LongTimeout)
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_nGage_Dashboard/Home/table_MyDocumentResults'), 1, colNo_DocType, DocType.INTERFACE_TEST_PR_ACTIVITY1.toString())
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_WMI/Interface Test PR/Business Process Audit/table_Activities'), 1, colNo_ActivityName, 'Activity1_0110')
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_WMI/Interface Test PR/Business Process Audit/table_Audit'), 2, colNo_InterfaceName, 'Add Related Item to Work Binder')
