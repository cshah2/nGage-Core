...
CustomKeywords.'actions.Common.selectDocClassAndDocTypeForGlobalNew'(DocClass.INTERFACE_TEST_PR.toString(),DocType.INTERFACE_TEST_PR_ACTIVITY2.toString())
...
'Click on Action'
CustomKeywords.'actions.Window.clickElementAndWaitForWindowClose'(findTestObject('Object Repository/Page_WMI/Interface Test PR/btn_A12_ChangeItemsClassType'), GlobalVariable.G_LongTimeout)
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_nGage_Dashboard/Home/table_MyDocumentResults'), 1, colNo_DocType, DocType.CLOSURE_ACTION.toString())
...
WebUI.waitForPageLoad(GlobalVariable.G_LongTimeout)
CustomKeywords.'actions.Common.waitForFrameToLoad'(findTestObject('Object Repository/Page_WMI/Closure Action/BPMProcessAudit/iframe_Close Window_ContentPla'))

'Verify activities table contains 1 record'
int rowCount_Activities = CustomKeywords.'actions.Table.getRowsCount'(findTestObject('Object Repository/Page_WMI/Closure Action/BPMProcessAudit/table_Activities'))
WebUI.verifyEqual(rowCount_Activities, 1)

'Verify process and activity name in Activities table'
int colNo_ProcessName = CustomKeywords.'actions.Table.getColumnNumber'(findTestObject('Page_WMI/Closure Action/BPMProcessAudit/tableHeader_Activities'), 'Process Name')
int colNo_ActivityName = CustomKeywords.'actions.Table.getColumnNumber'(findTestObject('Page_WMI/Closure Action/BPMProcessAudit/tableHeader_Activities'), 'Activity Name')
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Object Repository/Page_WMI/Closure Action/BPMProcessAudit/table_Activities'), 1, colNo_ProcessName, 'InterfaceTestProcess_28Jan2019')
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Object Repository/Page_WMI/Closure Action/BPMProcessAudit/table_Activities'), 1, colNo_ActivityName, 'Activity2_1120')

'Click on Activity in the table'
CustomKeywords.'actions.Table.clickCell'(findTestObject('Object Repository/Page_WMI/Closure Action/BPMProcessAudit/table_Activities'), 1, colNo_ProcessName)
CustomKeywords.'actions.Common.waitForFrameToLoad'(findTestObject('Object Repository/Page_WMI/Closure Action/BPMProcessAudit/iframe_Close Window_ContentPla'))
...
int colNo_InterfaceName = CustomKeywords.'actions.Table.getColumnNumber'(findTestObject('Page_WMI/Closure Action/BPMProcessAudit/tableHeader_Audit'), 'Interface Name')
int colNo_ReturnType = CustomKeywords.'actions.Table.getColumnNumber'(findTestObject('Page_WMI/Closure Action/BPMProcessAudit/tableHeader_Audit'), 'Return Type')
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_WMI/Closure Action/BPMProcessAudit/table_Audit'), 2, colNo_InterfaceName, 'Change Item`s Class/Type')
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_WMI/Closure Action/BPMProcessAudit/table_Audit'), 2, colNo_ReturnType, 'True')