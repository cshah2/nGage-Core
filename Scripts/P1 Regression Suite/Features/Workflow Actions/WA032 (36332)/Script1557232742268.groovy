...
'Click on Action'
CustomKeywords.'actions.Window.clickElementAndWaitForWindowClose'(findTestObject('Object Repository/Page_WMI/Interface Test PR/btn_A38_4_SetCalculated_CalendarDays'), GlobalVariable.G_LongTimeout)
