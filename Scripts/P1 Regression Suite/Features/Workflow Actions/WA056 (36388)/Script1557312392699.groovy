...
'Click on Action'
WebUI.click(findTestObject('Object Repository/Page_WMI/Interface Test PR/btn_A54_StopAction'))

'Verify close button'
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_WMI/Interface Test PR/btn_close'))

'Click on close button and Verify window is closed'
CustomKeywords.'actions.Window.clickElementAndWaitForWindowClose'(findTestObject('Object Repository/Page_WMI/Interface Test PR/btn_close'), GlobalVariable.G_LongTimeout)
