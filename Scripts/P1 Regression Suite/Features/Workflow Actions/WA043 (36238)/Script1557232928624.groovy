...
'Click on Action'
CustomKeywords.'actions.Window.clickElementAndWaitForWindowClose'(findTestObject('Object Repository/Page_WMI/Interface Test PR/btn_A33_RunDotNetVBScripts'), GlobalVariable.G_LongTimeout)
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_WMI/Interface Test PR/Business Process Audit/table_Audit'), 1, colNo_InterfaceName, 'Run .NET VB Scripts')
