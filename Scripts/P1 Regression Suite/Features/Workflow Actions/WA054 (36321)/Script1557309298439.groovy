...
'Click on Action'
WebUI.click(findTestObject('Object Repository/Page_WMI/Interface Test PR/btn_A40_ShowCustomMessage'))

'Click on OK button'
WebUI.click(findTestObject('Object Repository/Page_WMI/Interface Test PR/btn_OK'))
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_WMI/Interface Test PR/Business Process Audit/table_Audit'), 1, colNo_InterfaceName, 'Show Custom Message')
