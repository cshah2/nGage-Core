...
'Click on Action'
CustomKeywords.'actions.Window.clickElementAndWaitForWindowClose'(findTestObject('Object Repository/Page_WMI/Interface Test PR/btn_A38_2_SetCalculated_BusinessHours'), GlobalVariable.G_LongTimeout)
