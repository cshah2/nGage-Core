...
'Upload file'
WebUI.uploadFile(findTestObject('Page_WMI/Interface Test PR/File Upload/input_upload_File'), RunConfiguration.getProjectDir().replace('/', '\\')+'\\Data Files\\FileUploads\\text1.txt')
...
'Click on Action'
CustomKeywords.'actions.Window.clickElementAndWaitForWindowClose'(findTestObject('Object Repository/Page_WMI/Interface Test PR/btn_A17_2_CreatePDFDocFromTXTHTML'), GlobalVariable.G_LongTimeout)
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_nGage_Dashboard/Home/table_MyDocumentResults'), 2, colNo_DocType, DocType.INTERFACE_TEST_PR_ACTIVITY2.toString())
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_WMI/Interface Test PR/Business Process Audit/table_Activities'), 1, colNo_ActivityName, 'Activity2_1120')
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_WMI/Interface Test PR/Business Process Audit/table_Audit'), 2, colNo_InterfaceName, 'Create PDF Document From Text or HTML')
