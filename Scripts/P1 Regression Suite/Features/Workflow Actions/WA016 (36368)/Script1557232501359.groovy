...
'Click on Action'
CustomKeywords.'actions.Window.clickElementAndWaitForWindowClose'(findTestObject('Object Repository/Page_WMI/Interface Test PR/btn_A16_1_StartNewThread'), GlobalVariable.G_LongTimeout)
