...
'Click on Action'
CustomKeywords.'actions.Window.clickElementAndWaitForWindowClose'(findTestObject('Page_WMI/Interface Test PR/btn_A8_AssignUserOrUserGroup'), GlobalVariable.G_LongTimeout)
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_WMI/Interface Test PR/Business Process Audit/table_Audit'), 2, colNo_InterfaceName, 'Assign User/User Group')
