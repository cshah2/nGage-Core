...
'Data Object'
Map<Fields, String> data = P1_WMI_DOC362

'Click on Global New button'
WebUI.click(findTestObject('Page_nGage_Dashboard/input_btnGlobalNew'))

'Select DocClass and DocType'
CustomKeywords.'actions.Common.selectDocClassAndDocTypeForGlobalNew'(DocClass.INTERFACE_TEST_PR.toString(), DocType.INTERFACE_TEST_PR_RULES_OTHER.toString())
...
'Click on Rule'
CustomKeywords.'actions.Window.clickElementAndWaitForWindowClose'(findTestObject('Object Repository/Page_WMI/Interface Test PR_Rules/ExecuteRules_OtherGroup/span_ActionCompareTwoValues'), GlobalVariable.G_LongTimeout)
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_nGage_Dashboard/Home/table_MyDocumentResults'), 1, colNo_DocType, DocType.INTERFACE_TEST_PR_RULES_OTHER.toString())
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_WMI/Interface Test PR/Business Process Audit/table_Activities'), 1, colNo_ActivityName, 'ExecuteRules_OtherGroup')
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_WMI/Interface Test PR/Business Process Audit/table_Audit'), 2, colNo_InterfaceName, 'Compare Two Values')
