...
'Enter test Date'
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_WMI/Interface Test PR/Attach New Document/input_TestDate'), 10)
...
'Click on Rule'
CustomKeywords.'actions.Window.clickElementAndWaitForWindowClose'(findTestObject('Object Repository/Page_WMI/Interface Test PR_Rules/ExecuteRules_ItemRelatedGroup/btn_ActionCHeckItemHasRelatedItemsWithNotes'), GlobalVariable.G_LongTimeout)
...
CustomKeywords.'actions.Table.verifyCellContainsValue'(findTestObject('Page_WMI/Interface Test PR/Business Process Audit/table_Audit'), 2, colNo_InterfaceName, 'Check Item has Related Items with Notes')
