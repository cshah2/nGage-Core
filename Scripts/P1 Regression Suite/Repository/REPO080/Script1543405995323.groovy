...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/select_BM_Date'), 'Not Null', false)
...
'Verify date result for not null'
CustomKeywords.'actions.Table.verifyDateFilter'(findTestObject('Page_nGage_Dashboard/Repository/table_SearchResults'), 9, '05-09-2024', 'not null')