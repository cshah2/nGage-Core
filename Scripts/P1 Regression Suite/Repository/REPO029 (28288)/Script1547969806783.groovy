...
CustomKeywords.'actions.ContextMenu.clickOption'(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/contextMenu_Tabs'), 'Close all except this')

'Verify the Other tabs are closed'
...
'Verify the specific tab is not closed'
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/Business_Model_Tree/Tab_Closure'), GlobalVariable.G_LongTimeout)