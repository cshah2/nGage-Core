...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/select_DateRange'), 'Null', false)
...
'Verify date result for null'
CustomKeywords.'actions.Table.verifyDateFilter'(findTestObject('Page_nGage_Dashboard/Repository/table_SearchResults'), 9, '', 'null')