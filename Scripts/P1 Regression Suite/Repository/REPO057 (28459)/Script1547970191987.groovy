...
String bmDateTime = P1_REPO_DOC243.get(Fields.DATE_TIME)
String filter_BM_DateTime = convert(bmDateTime, FORMAT_DATETIME, FORMAT_DATE)
...
'Select operator (>=)'
WebUI.selectOptionByLabel(findTestObject('Page_nGage_Dashboard/Repository/select_BM_DateTime'), '>=', false)

'Enter date in DateTime field'
CustomKeywords.'actions.Common.setText_Date'(findTestObject('Page_nGage_Dashboard/Repository/input_BM___DateTime'), filter_BM_DateTime)
...
CustomKeywords.'actions.Table.verifyRecordPresentInColumn'(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/table_SearchResults'), colNo_BMDateTime, P1_REPO_DOC243.get(Fields.DATE_TIME))
CustomKeywords.'actions.Table.verifyRecordPresentInColumn'(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/table_SearchResults'), colNo_BMDateTime, P1_REPO_DOC244.get(Fields.DATE_TIME))
CustomKeywords.'actions.Table.verifyRecordPresentInColumn'(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/table_SearchResults'), colNo_BMDateTime, P1_REPO_DOC245.get(Fields.DATE_TIME))