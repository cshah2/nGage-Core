...
WebUI.setText(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/input_BM___DateTime'), '10-25-2018')
...
String dateValue = CustomKeywords.'actions.Table.getCellText'(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/table_SearchResults'), 1, 17)
println dateValue
'Verify date formate'
//CustomKeywords.'actions.Common.verifyDateFormat'(dateValue, 'MM/dd/yyyy HH:mm:ss tt')
CustomKeywords.'actions.Common.verifyDateFormat'(dateValue, 'MM/dd/yyyy HH:mm:ss a')