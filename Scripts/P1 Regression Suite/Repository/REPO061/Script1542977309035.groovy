...
'Enter date in DateTime field for = date result'
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/select_BM_DateTime'), 'Not Null', false)
...
CustomKeywords.'actions.Table.verifyDateFilter'(findTestObject('Page_nGage_Dashboard/Repository/table_SearchResults'), 17, '10/25/2018', 'not null')