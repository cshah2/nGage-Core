...
CustomKeywords.'actions.ContextMenu.clickOption'(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/contextMenu_Tabs'), 'Close all')
...
WebUI.verifyElementNotPresent(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/Business_Model_Tree/Tab_Closure'), GlobalVariable.G_LongTimeout)
