...
WebUI.verifyElementAttributeValue(findTestObject('Page_nGage_Dashboard/Repository/NewSearch_WithoutTab/input_Filter_BM String'), 'value', 'This is Test', GlobalVariable.G_LongTimeout)