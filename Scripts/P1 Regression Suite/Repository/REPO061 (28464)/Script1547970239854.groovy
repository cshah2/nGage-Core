...
WebUI.selectOptionByLabel(findTestObject('Page_nGage_Dashboard/Repository/select_BM_DateTime'), 'Not Null', false)
...
CustomKeywords.'actions.Table.verifyDateFilter'(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/table_SearchResults'), colNo_BMDateTime, filter_BM_DateTime, '', 'Not Null')