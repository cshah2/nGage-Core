...
WebUI.selectOptionByLabel(findTestObject('Page_nGage_Dashboard/Repository/select_BM_DateTime'), 'Not In', false)
...
CustomKeywords.'actions.Table.verifyRecordNotPresentInColumn'(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/table_SearchResults'), colNo_BMDateTime, P1_REPO_DOC243.get(Fields.DATE_TIME))