...
if(!FLAG_P1_REPO_DOC10) {
	CustomKeywords.'actions.Common.createDocument_RenderAllField'(P1_REPO_FIELD1_DOC10, P1_REPO_FIELD2_DOC10, '', '', '', '', '', '', '', '', '')
...
WebUI.verifyElementAttributeValue(findTestObject('Page_nGage_Dashboard/Repository/NewSearch_WithoutTab/input_Filter_BM String'), 'value', P1_REPO_FIELD2_DOC10, GlobalVariable.G_LongTimeout)