...
WebUI.selectOptionByLabel(findTestObject('Page_nGage_Dashboard/Repository/select_BM_Date'), 'Null', false)
...
CustomKeywords.'actions.Table.verifyDateFilter'(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/table_SearchResults'), colNo_BMDate, filter_BM_Date, 'Null')