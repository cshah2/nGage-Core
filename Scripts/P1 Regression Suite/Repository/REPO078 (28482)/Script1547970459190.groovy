...
WebUI.selectOptionByLabel(findTestObject('Page_nGage_Dashboard/Repository/select_BM_Date'), 'Not In', false)
...
CustomKeywords.'actions.Table.verifyRecordNotPresentInColumn'(findTestObject('Object Repository/Page_nGage_Dashboard/Repository/table_SearchResults'), colNo_BMDate, P1_REPO_DOC243.get(Fields.DATE))